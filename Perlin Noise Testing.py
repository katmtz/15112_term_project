...
File Info:
	**noise functions adapted from pseudocode by Hugo Elias**
	...
	Features:
	- can generate a basic demonstration of how tile distribution will look 
	on a larger map. (uses Tkinter)

	This is useful as a test bed to see how changes to the noise function 
